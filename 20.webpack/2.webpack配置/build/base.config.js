...
const webpack = require('webpack')//声明版权时使用

const HtmlWebpackPlugin = require("html-webpack-plugin")
//打包html文件，npm install html-webpack-plugin --save-dev
...
module.exports = {
    ...
    output:{
        ...
        filename:'bundle.js',
        //publicPath:"dist/"
        //publicPath加上后涉及到url的时候都会在路径前加上publicPath的路径,但是打包index.html文件到
        //dist文件夹中之后就可以注释掉了
    },
    //loader上官网文档查找
    ...
    plugins:[
        new webpack.BannerPlugin('以上版权归Levifun所有'),//在bundle.js文件中声明版权
        new VueLoaderPlugin(),//vue-loader的15以上版本都需要配置这个插件
        new HtmlWebpackPlugin({
            template: 'index.html'//根据根目录下的html文件生成打包之后的文件，并且在打包后的文件中自动插入bundle.js，index.html中就不需要引入了
        })//打包index.html文件到dist文件夹中
    ]
}